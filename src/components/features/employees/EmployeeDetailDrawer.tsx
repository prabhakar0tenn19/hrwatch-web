            ...
            <>
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  <Avatar name={employee.fullName} size="lg" className="w-14 h-14 text-base" />
                  <div>
                    <div className="flex items-center gap-2">
                      <h2 className="text-lg font-bold text-slate-900 leading-tight">{employee.fullName}</h2>
                      <span className="text-xs font-mono font-semibold px-2 py-0.5 rounded bg-slate-100 text-slate-600">
                        {employee.employeeCode}
                      </span>
                    </div>
                    <div className="text-xs text-slate-500 font-medium mt-0.5">{employee.designation}</div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-bold text-white bg-amber-500 hover:bg-amber-600 rounded-lg transition-all shadow-sm shrink-0"
                >
